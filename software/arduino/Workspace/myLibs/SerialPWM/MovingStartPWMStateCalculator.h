...
#ifndef MOVINGSTARTPWMSTATECALCULATOR_H_
#define MOVINGSTARTPWMSTATECALCULATOR_H_
 ...
 *
 */
class MovingStartPWMStateCalculator {
public:
	 ...
	 */
	MovingStartPWMStateCalculator(uint8_t channels);
	virtual ~MovingStartPWMStateCalculator();
...
private:
	...
	uint8_t startOffset;    // Number of step between the start of two successive channels
...
#endif /* MOVINGSTARTPWMSTATECALCULATOR_H_ */
